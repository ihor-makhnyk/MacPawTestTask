...
class FetchPersonnel: ObservableObject {
    ...
    //repository link
    let urlPers = "https://raw.githubusercontent.com/MacPaw/2022-Ukraine-Russia-War-Dataset/main/data/russia_losses_personnel.json"
...
class FetchEquipment: ObservableObject {
    ...
    //repository link
    let urlEquip = "https://raw.githubusercontent.com/MacPaw/2022-Ukraine-Russia-War-Dataset/main/data/russia_losses_equipment.json"
